...
<head>
    ...
    <meta charset="UTF-8">
    <title>500 | CartoonLovePangKung's Website</title>
</head>
<body bgcolor="#f1d2d4">
...
<li class="dropdown">		
    ...
    <marquee behavior="scrolling"><font color="red"><br>Error! 500 Internal Server Error!</marquee></font>
</ul>
<br>
<center>		
        <br>
        ...
        <br> 500
        <br> Internal Server Error</font>
        <br>
        <br> <font size="26">Tell me as soon as possible!
